...
LipiqQuan contains a section for specifying the number of replicates in the
...
in LipiqQuan. In the 'Threshold of instance' the user can specify what level of
