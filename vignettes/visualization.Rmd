...
#Introduction
This vignette will cover all the basic steps involved in lipidQuan
visualization.
...
```{r echo = FALSE}
library(knitr)
data <- read.csv(system.file("extdata/sampleTypes.csv", package = "lipidQuan"),
...
heatmap" field. If no number of clusters is specified, LipidQuan will determine
