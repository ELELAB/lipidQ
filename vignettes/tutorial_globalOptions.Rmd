...
quantification procedure in the LipidQuan GUI. The tutorial is divided into two
parts:
...
This file can now be used within our project by loading it into LipidQuan GUI in
