...
After selecting the data to be merged, you need to specify the output folder. This is done by writing or copy-pasting the path to the desired folder in the field below "Paste the filepath for the output files to be saved". The following describes how to obtain the full path:
...
After the folder path has been written, click on the "Merge Final Output Data Sets" to start the process.
