...
* The final output files generated from multiple LipiqQuan quantification runs
(see quantification tutorial for info on how to use the quantification procedure
in the LipidQuan GUI).
...
quantification runs with LipidQuan. Use the "Browse..." button to browse and
