...
#Introduction
the quantification procedure in lipidQuan needs 4 types of input in order to
...
needed as input for LipidQuan in order to translate the meaning of the columns
...
columns header name in the template is the default column name that LipidQuan
...
(ISTD) database are used in LipidQuan. They are both used to validate the
...
Only classes and species found in this database will go through the lipidQuan
